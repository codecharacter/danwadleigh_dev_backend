...
resource "aws_iam_user_policy_attachment" "admin_policy_attachment" {
  policy_arn = var.tf_be_policy_arn
...
resource "aws_s3_bucket_server_side_encryption_configuration" "s3_remotebe_encryption" {
  bucket = aws_s3_bucket.terraform_state_bucket.id
...
resource "aws_kms_key" "s3_tf_state_logging_kms" {
  description         = "s3_tf_state_logging_kms"
  enable_key_rotation = true
}

# TF Docs: https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_server_side_encryption_configuration
resource "aws_s3_bucket_server_side_encryption_configuration" "s3_remotebe_logging_encryption" {
